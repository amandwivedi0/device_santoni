...
HELPER="$ROOT/vendor/du/build/tools/extract_utils.sh"
if [ ! -f "$HELPER" ]; then
...
# Hax for cam configs
CAMERA2_SENSOR_MODULES="${ROOT}"/vendor/"${VENDOR}"/"${DEVICE}"/proprietary/vendor/lib/libmmcamera2_sensor_modules.so
